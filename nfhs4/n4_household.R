...
n4_household <- read_dta(paste0(path_dhs_folder,"/IA/IAHR74DT/IAHR74FL.dta"),col_select = household_vars$selected) %>% 
...
saveRDS(n4_household,paste0(path_nfhs_malnutrition_paper,"/working/n4_household.RDS"))
